...
-- Listage des données de la table keepitfit.exercises : ~17 rows (environ)
...
-- Listage des données de la table keepitfit.exercises_practice_places : ~17 rows (environ)
...
-- Listage des données de la table keepitfit.exercises_use_targetedareas : ~17 rows (environ)
...
-- Listage des données de la table keepitfit.materials : ~7 rows (environ)
...
-- Listage des données de la table keepitfit.programs : ~2 rows (environ)
...
-- Listage des données de la table keepitfit.sequencies : ~17 rows (environ)
...
-- Listage des données de la table keepitfit.targetedareas : ~13 rows (environ)
